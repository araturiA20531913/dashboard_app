...
import {PieChart,BarChart,LineChart,StackChart} from './../../uml';
// import {pie_chart,bar_chart,line_chart,stack_chart} from './../../uml';
// Update import statements in Analytics.jsx
// import pie_chart from './../../uml/pie_chart'; // Adjust the path as needed
// import bar_chart from './../../uml/bar_chart'; // Adjust the path as needed
// import line_chart from './../../uml/line_chart'; // Adjust the path as needed
// import stack_chart from './../../uml/stack_chart'; // Adjust the path as needed
  ...
  class Analytics extends React.Component {
      ...
      getSelectedChbox() {
        ...
        Array.prototype.push.apply(n, selected_data_number[e]);
            ...
            if(selchbox[y] == 'Pie Chart')
            {
                console.log(labels);
				console.log(myMap2);
                var chart_pie = new PieChart(labels,data_points,document.getElementById("chart-area1").getContext("2d"));
            ...
            {
                //console.log("2");
                var chart_bar = new BarChart(labels,data_points,document.getElementById("chart-area2").getContext("2d"));
            ...
            {
                var chart_line = new LineChart(labels,data_points,document.getElementById("chart-area3").getContext("2d"));
            ...
            else if(selchbox[y] == 'Stack Chart')
            {
                ...
                var chart_stack = new StackChart(lab,selected_data,document.getElementById("chart-area4").getContext("2d"));
    ...
    else if(file_name == this.Json2)
    {
        ...
        Array.prototype.push.apply(n, selected_data_number[e]);
            ...
            {
                //console.log("2");
                var chart_bar = new BarChart(labels,data_points,document.getElementById("chart-area2"));
                chart_bar.create_settings();
				const root = ReactDOM.createRoot(document.getElementById('chart-area2')); 
                root.render(chart_bar.drawChart());
            }
            ...
            else if(selchbox[y] == 'Stack Chart')
            {
                ...
                var chart_stack = new StackChart(labels,selected_data,document.getElementById("chart-area4").getContext("2d"));
                chart_stack.create_settings();
				const root = ReactDOM.createRoot(document.getElementById('chart-area4')); 
                root.render(chart_stack.drawChart());
            }
